...
(function()
{
  ...
  chrome.webRequest.onBeforeRequest.addListener(function(details)
  {
    try
    {
      ...
      var isMainFrame = requestType == "main_frame" || details.frameId == 0 && !(details.tabId in framesOfTabs);
      var frames = null;
      if (!isMainFrame)
      {
      ...
      if (!isMainFrame)
      {
        ...
        if (frame)
        {
          ...
          if (!ext.webRequest.onBeforeRequest._dispatch(details.url, requestType, new Page(
          {
            id: details.tabId
          }), frame))
          {
