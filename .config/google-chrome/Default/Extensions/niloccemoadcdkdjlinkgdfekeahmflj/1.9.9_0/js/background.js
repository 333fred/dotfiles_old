...
var backgroundPage = (function () {
    ...
    function loadNotificationUIIntoPage(tab, url, action, callback) {
        ...
        if (url) {
            ...
            if (action === "save") {
                executeScriptInTab(tab, "window.___PKT__URL_TO_SAVE = '" + url + "'; window.___PKT__PREM_STATUS = '" + premstatus + "'; window.___PKT__INJECTED = true;");
            }
            else if (action === "remove") {
                executeScriptInTab(tab, "window.___PKT__URL_TO_REMOVE = '" + url + "'; window.___PKT__PREM_STATUS = '" + premstatus + "'; window.___PKT__INJECTED = true;");
            }
        }
    ...
    (function initialize() {
        ...
        // TODO: exploit existing guid setting to pull in proper AB variant acll against ril object here
